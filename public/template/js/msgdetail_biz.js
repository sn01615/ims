...
$(function(){
    ...
    (function(){
        ...
        (function(){
            ...
            $.get('?r=api/GetMsgTexts',{msgid:msgId},function(data,textStatus){
                    ...
                    if(data.Ack=='Success'){
                        ...
                        (function(){
                            ...
                            (function(){
                                ...
                                _html = '<p><span class="leftName">BuyerUserID：</span><span class="rightVal"><a href="http://www.ebay.com/usr/'
                                        +clientId2+'" target="_blank" class="fontLinkBtn">'+clientId2+'</a> <span style="display:none" t="sc"></span></span></p>';
                                _html += '<p style="display:none" t="email"><span class="leftName">'+_lang.email+'</span><span class="rightVal"></span></p>';
                                _html += '<p style="display:none" t="paypalid"><span class="leftName">'+_lang.paypal_id+'</span><span class="rightVal"></span></p>';
                                _html += '<p style="display:none" t="n"><span class="leftName">'+_lang.buyer_name+'</span><span class="rightVal"></span></p>';
                                _html += '<p style="display:none" t="addr"><span class="leftName">'+_lang.address+'</span><span class="rightVal"></span></p>';
                                _html += '<p style="display:none" t="paypal_addr"><span class="leftName">'+_lang.pp_address+'</span><span class="rightVal"></span></p>';
                                _html += '<p style="display:none" t="phone"><span class="leftName">'+_lang.phone+'</span><span class="rightVal"></span></p>';
                                _html += '<p style="display:none" t="PayPalphone"><span class="leftName">'+_lang.pp_phone+'</span><span class="rightVal"></span></p>';
                                _html += '<p style="display:none" t="nt"><span class="leftName">'+_lang.order_msg+'</span><span class="rightVal"></span></p>';
                                $rval_1.html(_html);
                                
                                $window_client_info.find('span[t="id"]').html('<a href="http://www.ebay.com/usr/'
                                        +clientId2+'" target="_blank" class="fontLinkBtn">'+clientId2+'</a>');
                            })();
                        })();
                        ...
                        if(typeof data.Body.Contents!=='undefined'){
                            ...
                            for(var x in data.Body.Contents){
                                ...
                                if(data.Body.Contents[x].FolderID==1){
                                    _chtml+='<li class="sellerMSG"><div class="MSGC">'
                                        +'<p><b>[ '+data.Body.Contents[x].Sender+' ]</b>&nbsp;<span style="display:none" class="CSName" data-content_md5="'
                                        +data.Body.Contents[x].content_md5+'"></span>&nbsp;<span>'
                                        +intToLocalDate(data.Body.Contents[x].ReceiveDate,3)+'</span>'
                                        +'<small class="utime" style="display:none;" data-utime="'+data.Body.Contents[x].ReceiveDate+'"></small></p>'
                                        +'<div class="ef_content">'+_tempEm.innerHTML+'</div>'+data.Body.Contents[x].ImagePreview+'</div></li>';
                                    ...
                                    _chtml += '<small class="utime" style="display:none;" data-utime="' + data.Body.Contents[x].ReceiveDate + '"></small>';
                                    // 不需处理按钮
                                    _chtml += ' <a href="javascript:;" data-msgid="' + data.Body.Contents[x].msg_id + '" class="set_handled fontLinkBtn"';
                                    ...
                                    // 需处理按钮
                                    _chtml += ' <a href="javascript:;" data-msgid="' + data.Body.Contents[x].msg_id + '" class="set_not_handled fontLinkBtn"';
                                    ...
                                    _chtml += '</p>';
                                    _chtml += '<div class="ef_content">' + _tempEm.innerHTML + '</div>' + data.Body.Contents[x].ImagePreview + '</div></li>';
                                    _rcount++;
                                }
                                
                                if (typeof data.Body.Contents[x].OrderId != 'undefined' && data.Body.Contents[x].OrderId != '' && orderId.length == 0) {
                                    orderId = data.Body.Contents[x].OrderId;
                                    OmsgId = data.Body.Contents[x].msg_id;
                                }
                                
                                for(var y in data.Body.Contents[x].msgLabels){
                                    if ($("#msg_labels").find('[data-labelid="' + data.Body.Contents[x].msgLabels[y].msg_label_id + '"]').length > 0) {
                                        continue;
                                    }
                                    var _lhtml='<div class="nui-tag nui-tag'
                                        +data.Body.Contents[x].msgLabels[y].label_color
                                        +'"> <span class="nui-tag-text">'
                                        +data.Body.Contents[x].msgLabels[y].label_title
                                        +'</span> <span class="nui-tag-close" title="'+lang.msgdetail_biz.delete_label+'" data-labelid="'
                                        +data.Body.Contents[x].msgLabels[y].msg_label_id
                                        +'"><b>x</b></span> </div>';
                            ...
                            $("#rscount").html(lang.msgdetail_biz.msg_receive+':'+_rcount+' '+lang.msgdetail_biz.msg_send+':'+_scount).show();
                            defaultHeight();
                            ...
                            (function(){
                                ...
                                var template = '<div class="emailHead">'
                                    +'<p class="fixP"><span class="spanMode span80 leftName">'+_lang.sender+'</span><span class="rightVal">'+data.Body.Sender+'</span></p>'
                                    +'<p class="fixP"><span class="spanMode span80 leftName">'+_lang.received+'</span><span class="rightVal">'+data.Body.SendToName+'</span></p>'
                                    +'<p class="fixP"><span class="spanMode span80 leftName">'+_lang.time+'</span><span class="rightVal">'+intToLocalDate(data.Body.ReceiveDate,3)
                                    +'</span></p></div>';
                            ...
                            (function(){
                                if($("#itemDetailsComponent").length>0){
                                    if($("#itemDetailsComponent > table table td div table td div > a > img").attr('src').length>0){
                                        $("#info_item_img").find('img').attr('src',$("#itemDetailsComponent > table table td div table td div > a > img").attr('src')).parent().show();
                                    }
                                }
                            })();
                            ...
                            for(var y in data.Body.msgLabels){
                                ...
                                if($("#msg_labels").find('[data-labelid="'+data.Body.msgLabels[y].msg_label_id+'"]').length==0){
                                    var _lhtml='<div class="nui-tag nui-tag'
                                        +data.Body.msgLabels[y].label_color
                                        +'"> <span class="nui-tag-text">'
                                        +data.Body.msgLabels[y].label_title
                                        +'</span> <span class="nui-tag-close" title="'+lang.msgdetail_biz.delete_label+'" data-labelid="'
                                        +data.Body.msgLabels[y].msg_label_id
                                        +'"><b>x</b></span> </div>';
                                    $("#msg_labels").append(_lhtml);
                                }
                            }
                        ...
                        // 获取买家对卖家的所有评价
                        (function(){
                            $.get('?r=api/GetBuyerToSellerFeedbackInfo',{userId:data.Body.UserID},function(data,textStatus){
                                if(textStatus=='success'){
                                    if(data.Ack=='Success'){
                                        if(data.Body.length>0){
                                            ...
                                            $window_client_info.find('span[t="bNegative"]').parent().html(lang.msgdetail_biz.not_feedback).show();
                                        }
                                    }else{
                                        // hintShow('hint_f','服务器内部错误!请联系管理员');
                                    }
                        ...
                        (function(){
                            ...
                            if(typeof data.Body.ItemUrl!=='undefined' && data.Body.ItemUrl!=''){
                                ...
                                $("#item_title_p").find('a').attr('href','http://cgi.ebay.com/ws/eBayISAPI.dll?ViewItem&item='+(data.Body.user_id?data.Body.ItemID.replace(/(\d{8})\d{4}/,'$1****'):data.Body.ItemID));
                            }
                        })();
                        
                        (function(){
                            var _postdata={BuyerUserID:data.Body.UserID};
                            if(data.Body.EIASToken.length>10){
                                _postdata={EIASToken:data.Body.EIASToken};
                            }
                                        ...
                                        if(data.Body.length>0){
                                            for(var x in data.Body){
                                                ...
                                                for(var y in data.Body[x].ExtTrans){
                                                    transStr+=('<div class="textleft tooltip_td" title="'+_lang.time+intToLocalDate(data.Body[x].ExtTrans[y].ExternalTransactionTime,3)
                                                        +'<br />'+_lang.amount+data.Body[x].ExtTrans[y].PaymentOrRefundAmount+data.Body[x].ExtTrans[y].PaymentOrRefundAmount_currencyID+''
                                                        +'<br />'+_lang.FVF+data.Body[x].ExtTrans[y].FeeOrCreditAmount+data.Body[x].ExtTrans[y].FeeOrCreditAmount_currencyID+''
                                                        +'<br />'+_lang.status+data.Body[x].ExtTrans[y].ExternalTransactionStatus+''
                                                ...
                                                (!data.Body[x].Phone&&data.Body[x].Phone=='')?null:addressStr+='<br/>'+lang.msgdetail_biz.phone+':'+data.Body[x].Phone;
                                                ...
                                                $("#buyHistory_div").find('tbody').append('<tr data-key='+x+'><td>'+data.Body[x].SellerUserID
                                                    ...
                                                    +data.Body[x].PaymentMethod+transStr+'</td>'
                                                    +(data.Body[x].AddressID?'<td><a href="javascript:;" title="'+addressStr+'" class="tooltip_td">'+lang.msgdetail_biz.view+'</a></td>':
                                                    '<td title="'+lang.msgdetail_biz.none+'">-</td>')
                                                    +'<td>'+orderStatus+'</td>'+'<td>'+CommentTypeStr+'</td>'+'<td t="note" class="tooltip_td">..</td></tr>');
                                                        ...
                                                        if(data.Ack=='Success'){
                                                            ...
                                                            for(var x in data.Body){
                                                                noteText[x]=(_lang.author+data.Body[x].author_name
                                                                    ...
                                                                    +'<br/>'+_lang.time+intToLocalDate(data.Body[x].create_time,7));
                                                            }
                                                            $("#buyHistory_div").find('tr[data-key='+_key+']').find('td[t="note"]').html('<i class="icon-remark"></i>').attr('title',noteText.join('<br /><br />'));
                                                            //执行鼠标经过气泡提示方法
                                                            tooltip($('.tooltip_td'));
                                                        }else if(data.Ack=='Warning'){
                                                            $("#buyHistory_div").find('tr[data-key='+_key+']').find('td[t="note"]').html(lang.msgdetail_biz.none);
                                                        }else{
                                            ...
                                            $("#buyHistory_div").find('tbody').append('<tr><td colspan="10">'+lang.msgdetail_biz.not_data+'</td></tr>');
                                        }
                                    }else{
                        ...
                        (function(){
                            ...
                            if(orderId.length==0){
                                ...
                                (function(){
                                    // 没有订单号的时候显示itemSite
                                    $.get('?r=api/GetItemInfoByItemId',{'msgid':msgId},function(d,status){
                                ...
                                if(status==='success'){
                                    if(data.Ack==='Success'){
                                        ...
                                        for(var i=0;i<data.Body.length;i++){
                                            ...
                                            $rval_1.find('p[t="n"]>.rightVal').html(data.Body[i].Buyer_UserFirstName+' '+data.Body[i].Buyer_UserLastName).parent('p').show();
                                            ...
                                            (data.Body[i].VariationSpecificsXML.xml.NameValueList.length>0||(
                                                typeof data.Body[i].VariationSpecificsXML.xml.NameValueList.Name==='string'&&
                                            ...
                                            _td += '<td>' + data.Body[i].TransactionPrice + data.Body[i].TransactionPrice_currencyID + '</td>';
                                            _td += '<td style="line-height:1.1em;">' + intToLocalDate(data.Body[i].CreatedDate, 3) + '</td>';
                                            _td += '</tr>';
                            ...
                            $.get("?r=api/GetEbayOrderInfo",{OrderLineItemID:orderId},function(data,status){
                                if(status==='success'){
                                    if(data.Ack==='Success'){
                                        var addrStr = '';
                                        addrStr += data.Body.Name + ', ';
                                        addrStr += data.Body.Street1 + ', ';
                                        addrStr += (typeof data.Body.Street2 !== 'undefined' && data.Body.Street2 !== null && data.Body.Street2.length > 0 ? (data.Body.Street2 + ', ') : '');
                                        addrStr += data.Body.CityName + ', ';
                                        addrStr += data.Body.StateOrProvince + ', ';
                                        addrStr += (typeof data.Body.PostalCode !== 'undefined' && data.Body.PostalCode !== null && data.Body.PostalCode.length > 0 ? data.Body.PostalCode + ', ' : '');
                                        // +(typeof data.Body.Country!=='undefined'
                                        //     && data.Body.Country.length>0
                                        //     ?data.Body.Country:'')
                                        addrStr += (typeof data.Body.CountryName !== 'undefined' && data.Body.CountryName !== null && data.Body.CountryName.length > 0 ? data.Body.CountryName : '');
                                        ...
                                        if(typeof data.Body.Phone!=='undefined' && data.Body.Phone!='Invalid Request' && data.Body.Phone && data.Body.Phone.length>0){
                                        ...
                                        var _ShippingInfo='<div>'+((data.Body.ShippingServiceDetails===false)?
                                            data.Body.ShippingService:data.Body.ShippingServiceDetails.Description)+'</div>';
                                        
                                        if(data.Body.ShippingServiceCost>0){
                                            // ShippingServiceCost
                                            _ShippingInfo+='<div>'+lang.msgdetail_biz.order_info.carriage+':'+data.Body.ShippingServiceCost+data.Body.ShippingServiceCost_currencyID+'</div>';
                                        }
                                        
                                        if(data.Body.ExtTrans.length>0){
                                            var _lang=lang.msgdetail_biz.transactions_info;
                                            for(var i=0;i<data.Body.ExtTrans.length;i++){
                                                transids+=('<div class="textleft tooltip_td" title="'+_lang.time+intToLocalDate(data.Body.ExtTrans[i].ExternalTransactionTime,3)
                                                    +'<br />'+_lang.amount+data.Body.ExtTrans[i].PaymentOrRefundAmount+data.Body.ExtTrans[i].PaymentOrRefundAmount_currencyID+''
                                                    +'<br />'+_lang.FVF+data.Body.ExtTrans[i].FeeOrCreditAmount+data.Body.ExtTrans[i].FeeOrCreditAmount_currencyID+''
                                                    +'<br />'+_lang.status+data.Body.ExtTrans[i].ExternalTransactionStatus+''
                                                    +'">'+data.Body.ExtTrans[i].ExternalTransactionID
                                                    +'('+ data.Body.ExtTrans[i].PaymentOrRefundAmount+data.Body.ExtTrans[i].PaymentOrRefundAmount_currencyID +')'
                                                    +'</div>');
                                                ...
                                                (function(){
                                                    ...
                                                    $.get('?r=api/GetPaypalAddressByExtTransID',{TransactionID:data.Body.ExtTrans[i].ExternalTransactionID},function(data,status){
                                                        // console.log(data);
                                                        if(data.Ack=='Success'){
                                                            if(data.Body.code==200){
                                                                if(data.Body.data.body.length>0){
                                                                    if(data.Body.data.body[0].BuyerEmail!=''){
                                                                        ...
                                                                        $('#window_client_info_r').find('span[t="paypalid"]').find('span[x="'+data.Body.data.body[0].BuyerEmail+'"]').remove();
                                                                        $('#window_client_info_r').find('span[t="paypalid"]').append('<span x="'+data.Body.data.body[0].BuyerEmail+'">'
                                                                            +data.Body.data.body[0].BuyerEmail+'</span>').closest('li').show();
                                                                        $('#window_client_info_r').show();
                                                                        
                                                                        $rval_1.find('p[t="paypalid"]>.rightVal').find('span[x="'+data.Body.data.body[0].BuyerEmail+'"]').remove();
                                                                        $rval_1.find('p[t="paypalid"]>.rightVal').append('<span x="'+data.Body.data.body[0].BuyerEmail+'">'
                                                                            +data.Body.data.body[0].BuyerEmail+'</span>').parent('p').show();
                                                                        
                                                                        if(data.Body.data.body[0].Phone.length>0){
                                                                            $rval_1.find('p[t="PayPalphone"]>.rightVal').append(data.Body.data.body[0].Phone+' ').parent('p').show();
                                                                        }
                                                                        
                                                                        if(data.Body.data.body[0].BuyerID!=''){
                                                                            var paypal_addrStr = '';
                                                                            paypal_addrStr += data.Body.data.body[0].BuyerName;
                                                                            paypal_addrStr += ', '+data.Body.data.body[0].Street1;
                                                                            if(data.Body.data.body[0].Street2.length>0){
                                                                                paypal_addrStr += ', '+data.Body.data.body[0].Street2;
                                                                            }
                                                                            paypal_addrStr += ', '+data.Body.data.body[0].CityName;
                                                                            paypal_addrStr += ', '+data.Body.data.body[0].Province;
                                                                            paypal_addrStr += ', '+data.Body.data.body[0].PostCode;
                                                                            paypal_addrStr += ', '+data.Body.data.body[0].CountryName;
                                                                            // $rval_1.find('p[t="paypal_addr"]>.rightVal').html(paypal_addrStr).parent('p').show();
                                                                            $rval_1.find('p[t="paypal_addr"]>.rightVal').append(paypal_addrStr).parent('p').show();
                                                                        }else{
                                        ...
                                        if(data.Body.Trans.length>0){
                                            for(var i=0;i<data.Body.Trans.length;i++){
                                                if(typeof data.Body.Trans[i].ShippingDetailsXML!=='undefined'
                                                    &&data.Body.Trans[i].ShippingDetailsXML!==null
                                                    &&typeof data.Body.Trans[i].ShippingDetailsXML.xml!=='undefined'
                                                    &&typeof data.Body.Trans[i].ShippingDetailsXML.xml.ShipmentTrackingDetails!=='undefined'){
                                                    _ShippingInfo+='<div>CarrierUsed:'+data.Body.Trans[i].ShippingDetailsXML.xml.ShipmentTrackingDetails.ShippingCarrierUsed+'</div>';
                                                    _ShippingInfo+='<div>TrackingNumber:<br /><a href="#track_number='
                                                    ...
                                                    +data.Body.Trans[i].ShippingDetailsXML.xml.ShipmentTrackingDetails.ShipmentTrackingNumber+'" data-carrier="'
                                                    +data.Body.Trans[i].ShippingDetailsXML.xml.ShipmentTrackingDetails.ShippingCarrierUsed+'">'
                                                    +data.Body.Trans[i].ShippingDetailsXML.xml.ShipmentTrackingDetails.ShipmentTrackingNumber+'</a></div>';
                                                }
                                            }
                                        }
                                        ...
                                        if(data.Body.ShippedTime==0){
                                            ...
                                            $msg_payment.find('tbody').find('tr>td').eq(2).html(intToLocalDate(data.Body.ShippedTime,3));
                                        }
                                        ...
                                        (function() {
                                            $.get('?r=api/GetEbayFeedbackInfoByOLID', {
                                                ...
                                                if (d.Ack == 'Failure') {
                                                    $msg_payment.find('tbody').find('tr>td').eq(3).html(lang.msgdetail_biz.none);
                                                    ...
                                                    $msg_payment.find('tbody').find('tr>td').eq(3).html('<i class="' + type + '"></i>');
                                                }
                                            });
                                        })();
                                ...
                                if(status==='success'){
                                    if(data.Ack==='Success'){
                                        if(data.Body.FeedbackScore!=''){
                                            ...
                                            +data.Body.FeedbackRatingStar+')'+' '+lang.msgdetail_biz.positive+':'+data.Body.PositiveFeedbackPercent).show();
                                        }
                                        ...
                                        (function(){
                                            ...
                                            data.Body.regaddr_Phone.length<=0?'':RaddrStr+='<br />'+lang.msgdetail_biz.reg_phone+': '+data.Body.regaddr_Phone+', ';
                                            
                                            if(RaddrStr.length>12){
                                                $("#window_client_info_l").append('<li style=""><span class="leftName">'+lang.msgdetail_biz.reg_address+'</span><span class="rightVal" style="width:370px;">'
                                                    +RaddrStr+'</span></li>');
                                            }
                                        })();
                                        ...
                                        (function(){
                                            ...
                                            // 其他地址显示
                                            var pdata = {EIASToken:data.Body.EIASToken};
                                            if(data.Body.EIASToken==''){
                                                pdata = {userId:data.Body.UserID};
                                            }
                                            $.get('?r=api/GetUserAddress', pdata, function(data,textStatus){
                                                if(textStatus=='success'){
                                                    if(data.Ack=='Success'){
                                                        for(var x in data.Body){
                                                            var addrStr = data.Body[x].Name+', '
                                                                +data.Body[x].Street1+', '
                                                                +(data.Body[x].Street2.length>0?(data.Body[x].Street2+', '):'')
                                                                +data.Body[x].CityName+', '
                                                                +data.Body[x].StateOrProvince+', '
                                                                +(typeof data.Body[x].PostalCode!=='undefined'
                                                                    && data.Body[x].PostalCode.length>0
                                                                ...
                                                                +(typeof data.Body[x].CountryName!=='undefined'
                                                                    && data.Body[x].CountryName.length>0
                                                                    ?data.Body[x].CountryName:'');
                                                            if(data.Body[x].Phone.length>0){
                                                                addrStr+=('<br />'+lang.msgdetail_biz.order_phone+data.Body[x].Phone);
                                                            }
                                                            
                                                            $("#window_client_info_l").append('<li style=""><span class="leftName">'+lang.msgdetail_biz.order_address+(+x+1)+'：</span><span class="rightVal" style="width:370px;">'
                                                                +addrStr+'</span></li>');
                                                        }
                                                    }else if(data.Ack=='Warning'){
                        ...
                        $.get('?r=api/GetMsgCaseInfo',{msgid:OmsgId},function(data,status){
                            // console.log(data,status);
                            if(data.Ack=='Success' && status=='success'){
                                var _chtml='';
                                for(var x in data.Body.cases){
                                    if(data.Body.cases[x].caseId_type!='CANCEL_TRANSACTION'){
                                        _chtml+='<a href="?r=Home/DisputeDetail&caseid='
                                            +data.Body.cases[x].case_id
                                            +'&type='
                                            +data.Body.cases[x].caseId_type
                                            +'" target="_blank" class="fontLinkBtn">'
                                            +data.Body.cases[x].caseId_type
                                            +'</a> ';
                                    }
                                }
                                for(var x in data.Body.disputes){
                                    if(data.Body.disputes[x].DisputeReason=='TransactionMutuallyCanceled'){
                                        _chtml+='<a href="?r=Home/DisputeDetail&caseid='
                                            +data.Body.disputes[x].disputes_id
                                            +'&type=cancel" target="_blank" class="fontLinkBtn">'
                                            +data.Body.disputes[x].DisputeReason
                                            +'</a> ';
                                    }
                                }
                                for(var x in data.Body.returns){
                                    _chtml+='<a href="?r=Home/ReturnDetail&returnid='
                                        +data.Body.returns[x].return_request_id
                                        +'" target="_blank">'
                                        +data.Body.returns[x].return_type
                                        +'</a> ';
                                }
        ...
        $.get('?r=api/ShowMessage&mids='+msgId+'&c='+msgType,{_rnd:loading()},function(result,status){
            // return;
            removeloading();
            if(result.Ack=='Success'){
                ...
                (function(){
                    var msgRemark='<div class="remark">'
                    +'<textarea type="text" id="note-text"></textarea>'
                    +'<p><button class="subBtn" id="sub-note">'+lang.msgdetail_biz.save_btn+'</button></p>'
                    +'<ul id="note"></ul>'
                    +'</div>';
                ...
                (function(){
                    ...
                    var icon = '<i class="'+star+'" title="'+lang.msgdetail_biz.marked_star+'" id="star" data-id="'+CC.is_star+'"></i>'
                        +'<span class="noBgBtn" id="dispose" data-id="'+CC.handled+'" style="display:none">'+lang.msgdetail_biz.not_action+'</span>';
                        ...
                        $.get('?r=api/getLastSendMsg&msgid='+CC.msg_id, function(data,status){
                            ...
                            if(status === 'success' && data.Ack === 'Success'){
                                ...
                                if(typeof(data.Body.image_urls)!=='undefined'){
                                    ...
                                    $('<li><i class="icon-close iconBtnS" title="'+lang.msgdetail_biz.click_delete+'"></i><img src="'+data.Body.image_urls[x]
                                    ...
                                    if(data.Body.length>0){
                                        for(var x in data.Body){
                                            $his_msgs_ul.append('<li data-msgid="'+data.Body[x].msg_id+'" title="'+data.Body[x].Subject+'">'
                                                ...
                                                +((data.Body[x].FolderID==1)?lang.msgdetail_biz.msg_his.send:lang.msgdetail_biz.msg_his.received)
...
//            }
                ...
                if (state === 'success') {
                    if (listdata.Body.list !== '') {
                        $.each(listdata.Body.list, function(index, item) {
                            $('#class_box select[pid=' + pid + ']').append('<option value="' + item.tp_list_id + '">' + item.title + '</option>');
                        });
    ...
    (function(){
        ...
        $oSendContent.on('input change', function(){
            ...
            if(length<0){
                ...
                $('#StrLength').find('span').html(lang.msgdetail_biz.input_max_tip_l+'<b style="color: #f00;">'+length+'</b>'+lang.msgdetail_biz.input_max_tip_r);
            } else {
    ...
    $('#sendMsg').on('click',function(){
        ...
        loading();
        $.post('?r=Api/ReplyMsg',{'msgid':mid,'content':msgBody,'imgurl':global.imgurl,'copy':copy},function(result,status){
                        ...
                        if (result.Body.Pk > 0) {
                            ...
                            $.get('?r=api/GetMsgReplyStatus', {
                                ...
                                if (status === 'success' && data.Ack === 'Success') {
                                    ...
                                    var timeSec = 3;
                                    setInterval(function() {
                                        $('body .stateGB .stateBox').html(lang.msgdetail_biz.msg_send_sync_success + ',' + timeSec + lang.msgdetail_biz.close_window_tip2);
                                        timeSec--;
                                        if (timeSec <= 0) {
                                            window.close();
                                        }
    ...
    function getItemNoteList(){
        ...
        $.ajax({
                ...
                data:{'itemId':itemId,'type':'msg','msgId':msgId},
    ...
    $('#remarkS').on('click','#sub-note',function(){
        ...
        $.post('?r=api/AddItemNote',{text:text,msgid:msgId},function(data,status){
            if(data.Error=='User authentication fails'){
                hintShow('hint_w',lang.ajaxinfo.permission_denied);
                return;
            } 
    ...
    $('#determine').on('click',function(){
        ...
        $('.imglist_addwindow').empty();
        for(var i in img){
            $('<li><i class="icon-close iconBtnS" title="'+lang.msgdetail_biz.click_delete+'"></i><img src="'+img[i]+'" width="70px" height="60px"></li>').appendTo('.imglist_addwindow');
        }
    ...
    (function(){
        ...
        $("#drop-area-div").dmUploader({
            ...
            extraData:{refid:$("#emailDetail").attr('mid'),src:'msgid'},
            // maxFiles:5,
    ...
    $('#addFile').on('click',function(){
        ...
        $('.imglist_addwindow').empty();
        for(var i in img){
            $('<li><i class="icon-close iconBtnS" title="'+lang.msgdetail_biz.click_delete+'"></i><img src="'+img[i]+'" width="70px" height="60px"></li>')
        ...
        $.get('?r=api/GetTrackingInfo', {
            ...
            if (data.Ack == 'Success') {
                ...
                if (data.Body.packageDetails.ServiceCode) {
                    ...
                    _html += '<li><span>【' + lang.msgdetail_biz.logistics.service + '】：</span>' + _dt.ServiceName + ' ' + _dt.ServiceCode + '</li>';
                    ...
                    _html += '<li><span>【' + lang.msgdetail_biz.logistics.total_weight + '(kg)】：</span>' + (_dt.WeightForCharge !== null ? _dt.WeightForCharge / 1000 : 'unknown') + '</li>';
                    // _html += '<li><span>【View the proof】：</span>Deldkdkdf</li>';
                    $('#logistics_package_detail').html(_html);
                } else {
                    var _html = '<li>' + lang.msgdetail_biz.logistics.not_data + '<a href="' + _trackingurl + '" target="_blank">' + lang.msgdetail_biz.logistics.click_view + '</a></li>';
                    $('#logistics_package_detail').html(_html);
                }
            } else {
                $('#logistics_detail_tr').append('<tr><td colspan="4">' + lang.msgdetail_biz.logistics.not_data + '<a href="' + _trackingurl + '" target="_blank">' + lang.msgdetail_biz.logistics.click_view + '</a></td></tr>');
                $('#logistics_package_detail').append('<tr><td colspan="4">' + lang.msgdetail_biz.logistics.not_data + '<a href="' + _trackingurl + '" target="_blank">' + lang.msgdetail_biz.logistics.click_view + '</a></td></tr>');
            }
        });
    });
