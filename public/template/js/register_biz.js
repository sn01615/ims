...
$(document).ready(function(e){
    ...
    $oName.blur(function(){
        ...
        if(userName !== ''){
            $.get('?r=api/CheckUser',{'username':userName},function(result,state){
    ...
    $("#register").on('click',function(){
        ...
        var i = 1;
        var TitArr = [lang.register_biz.inp_login_acc,lang.register_biz.inp_pass,lang.register_biz.inp_pass,lang.register_biz.inp_name,lang.register_biz.inp_phone_num,lang.register_biz.email,lang.register_biz.inp_verify ];
            ...
            $.get("?r=api/RegisterUser",{
                ...
                if(result.Ack === 'Success'){
                    ...
                    if (result.Error == 'You do not have permission to add users'){
                        $(".verifyerr").html(lang.register_biz.first_please+'<a href="javasctipt" id="ajax_logout">'+lang.register_biz.login_out+'</a>');
