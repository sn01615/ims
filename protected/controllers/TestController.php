...
class TestController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if (! isset($_SERVER['PHP_AUTH_USER']) || ! isset($_SERVER['PHP_AUTH_PW']) || $_SERVER['PHP_AUTH_USER'] != ADMIN_USERNAME ||
            ...
            Header("WWW-Authenticate: Basic realm=\"TestController Login\"");
...
EOB;
    ...
    public function actionTest8()
    {
        ...
        $token = 'AgAAAA**AQAAAA**aAAAAA**dVWXVg**nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6AGmYShDpmFoAudj6x9nY+seQ**B8ICAA**AAMAAA**';
    ...
    public function actionTest9()
    {
        ...
        $token = 'AgAAAA**AQAAAA**aAAAAA**lP4+VQ**nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6AElYGkAZKFogydj6x9nY+seQ**+uQAAA**AAMAAA**';
        $token = 'AgAAAA**AQAAAA**aAAAAA**25JJVg**nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6AGl4OgDZaEpA6dj6x9nY+seQ**B8ICAA**AAMAAA**';
        echo CaseDownModel::model()->getEBPCaseDetail('5102913371', 'EBP_SNAD', $token);
    }
...
eot;
    ...
    public function actionTest31()
    {
        // imsTool::xmlHeader();
        $token = 'AgAAAA**AQAAAA**aAAAAA**hVSXVg**nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6AGl4qoCJaAqAWdj6x9nY+seQ**B8ICAA**AAMAAA**';
        $xml = ReturnDownModel::model()->getUserReturns(time() - 3600 * 24 * 90, time() - 3600 * 24 * 60, '', '', '', $token, 0, 1, 200);
        // echo $xml;
        $doc = phpQuery::newDocumentXML($xml);
        phpQuery::selectDocument($doc);
        ...
        for ($i = 0; $i < $length; $i ++) {
            ...
            var_dump($returns->eq($i)->find('ns1:ReturnId')->html());
        }
